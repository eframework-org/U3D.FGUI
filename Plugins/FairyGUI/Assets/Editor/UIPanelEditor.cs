...
namespace FairyGUIEditor
{
    ...
    /// 
    /// </summary>
    [CustomEditor(typeof(FairyGUI.UIPanel), true)]
    public class UIPanelEditor : Editor
    {
        protected SerializedProperty packageName;
        protected SerializedProperty componentName;
        protected SerializedProperty packagePath;
        protected SerializedProperty renderMode;
        protected SerializedProperty renderCamera;
        ...
        protected SerializedProperty fairyBatching;
        protected SerializedProperty fitScreen;
        protected SerializedProperty touchDisabled;
        protected SerializedProperty hitTestMode;
        protected SerializedProperty setNativeChildrenOrder;

...
namespace FairyGUI
{
    ...
    public class UIPanel : MonoBehaviour, EMRenderTarget
    {
        ...
        public bool fairyBatching = false;
        [SerializeField]
        protected bool touchDisabled = false;
        [SerializeField]
        protected Vector2 cachedUISize;
        [SerializeField]
        protected HitTestMode hitTestMode = HitTestMode.Default;
        [SerializeField]
        protected bool setNativeChildrenOrder = false;
        ...
        public virtual void SetSortingOrder(int value, bool apply)
        {
        ...
        public virtual void SetHitTestMode(HitTestMode value)
        {
        ...
        /// 
        /// </summary>
        public virtual void CacheNativeChildrenRenderers()
        {
            if (_renders == null)
        ...
        protected virtual void CreateUI_PlayMode()
        {
            _created = true;
        ...
        protected virtual void UpdateHitArea()
        {
        ...
        protected virtual void CreateUI_EditMode()
        {
        ...
        protected virtual void HandleScreenSizeChanged()
        {
            if (!Application.isPlaying)
                DisplayObject.hideFlags = HideFlags.DontSaveInEditor;
        ...
        protected virtual void OnUpdateSource(object[] data)
        {
            if (Application.isPlaying)
                return;
        ...
        public virtual void ApplyModifiedProperties(bool sortingOrderChanged, bool fitScreenChanged)
        {
            if (container != null)
            {
        ...
        public virtual void MoveUI(Vector3 delta)
        {
            if (fitScreen != FitScreen.None)
                return;
        ...
        public virtual Vector3 GetUIWorldPosition()
        {
            if (_ui != null)
        ...
        public virtual void EM_BeforeUpdate()
        {
            if (container == null)
                CreateContainer();
        ...
        public virtual void EM_Update(UpdateContext context)
        {
            DisplayObject.hideFlags = HideFlags.DontSaveInEditor;
